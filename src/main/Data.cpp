...
{
    fprintf(fid, "%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f",time,pcx,pcy,pcz,w0, w1, w2, w3, prob0, prob1, prob2, prob3,   wStanceA,  wStanceB,  probStanceA,  probStanceB, wSwingA,  wSwingB,  probSwingA,  probSwingB, ev_x, ev_y, ev_z, imu_x,  imu_y,  imu_z,  fAx,  fAy, fAz, fBx, fBy, fBz ); 
    //move to a newline
    fprintf(fid,"\n");
}